...
public class MicroscopeCaptureResponse extends BaseMessageAdaptor {
    private static final Logger logger = Logger
            .getLogger(MicroscopeCaptureResponse.class);
    public static final String TYPE = "MICRO_2";
    private File image;
    private InputStream inputStream;

    public MicroscopeCaptureResponse() {
    }
